...
def assert_get_exercise_response(actual: GetExerciseResponseSchema, expected: GetExerciseResponseSchema):
    """
    ...
    assert_equal(actual.exercise.order_index, expected.exercise.order_index, "order index")
    assert_equal(actual.exercise.description, expected.exercise.description, "description")
    assert_equal(actual.exercise.estimated_time, expected.exercise.estimated_time, "estimate time")