...
from clients.courses.course_schema import UpdateCourseRequestSchema, UpdateCourseResponseSchema,GetIDCoursesResponseSchema
from clients.courses.courses_client import CoursesClient
from fixtures.courses import CoursesFixture
from tools.assertions.base import assert_status_code
from tools.assertions.courses import assert_update_course_response, assert_get_id_course_response
...
class TestCourses:
    def test_update_course(self, courses_client: CoursesClient, function_course: CoursesFixture):
        ...
        response = courses_client.update_course_api(request=request, course_id= function_course.response.course.id)
        ...
        response_get = courses_client.get_course_api(course_id=function_course.response.course.id)
        response_data_get = GetIDCoursesResponseSchema.model_validate_json(response_get.text)
