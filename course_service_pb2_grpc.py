...
class CourseServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCourse = channel.unary_unary(
            ...
            request_serializer=course__service__pb2.GetCoursesRequest.SerializeToString,
            response_deserializer=course__service__pb2.GetCousesResponse.FromString,
...
def add_CourseServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "GetCourse": grpc.unary_unary_rpc_method_handler(
            servicer.GetCourse,
            request_deserializer=course__service__pb2.GetCoursesRequest.FromString,
            response_serializer=course__service__pb2.GetCousesResponse.SerializeToString,
        ),
    }
...
class CourseService(object):
    ...
    def GetCourse(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/CourseService/GetCourse",
            course__service__pb2.GetCoursesRequest.SerializeToString,
            course__service__pb2.GetCousesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
